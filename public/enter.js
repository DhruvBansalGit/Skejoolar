...
addNote = () => {
    ...
    if (title.length == 0) {
        ...
        if (localStorage.getItem('enter') == null) {
            ...
            data = JSON.parse(localStorage.getItem('enter'))
        }
        ...
        localStorage.setItem('enter', data);
...
/* Perfect */
showNotes = () => {
    let notes = localStorage.getItem('enter');
...
/* Perfect */
deleteNotes = (id) => {
    let data = JSON.parse(localStorage.getItem('enter'));
    data.splice(id, 1);
    data = JSON.stringify(data);
    localStorage.setItem('enter', data);
...
<head>
    ...
    <meta name="keywords" content="todo, list, reminder, enter">
